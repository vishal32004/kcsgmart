...
export default function EnhancedAboutUs() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setAnimatedStats((prev) => ({
        clients: Math.min(prev.clients + 1, 500),
        projects: Math.min(prev.projects + 1, 1000),
        awards: Math.min(prev.awards + 1, 50),
      }));
    }, 20);
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "Their innovative solutions have transformed our business. We couldn't be happier with the results.",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 container">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="mt-3 text-xl text-gray-500 sm:mt-5 sm:text-2xl lg:text-xl xl:text-2xl mb-8">
              We are a passionate team dedicated to creating innovative
              solutions for businesses worldwide. Our mission is to transform
              ideas into reality and help our clients achieve their goals.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              ...
              <motion.div
                ...
                className="bg-white p-6 rounded-lg shadow-lg text-center"
              >
                <Briefcase className="w-8 h-8 mx-auto mb-4 text-green-500" />
                <h2 className="text-5xl font-bold text-gray-900 mb-2">
          ...
          >
            <Image
              className="rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-full lg:max-w-none object-cover"
      ...
      <div className="w-full bg-[#f9f9f9] pt-12 p-4">
